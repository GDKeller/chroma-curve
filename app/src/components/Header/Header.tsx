  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 lg:px-6">
      <div className="flex items-center gap-2">
        ...
        <p className="text-2xs/tight text-text-faint hidden max-w-32 sm:block md:max-w-44 md:text-xs lg:text-xs">
          Parabolic saturation correction for monochromatic color palettes
        </p>
        <AboutButton />
      </div>
      <div className="flex items-center gap-3">
        <span className="text-text-faint hidden items-center gap-1 text-sm md:flex">
          <Copy size={12} />
