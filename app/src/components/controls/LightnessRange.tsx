      ...
      <div className="flex items-center justify-between px-1">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex items-center text-xs font-mono cursor-pointer transition-colors ${locked ? "text-text-primary" : "text-text-faint"}`}
          ...
          <span className="text-sm font-mono text-text-primary tabular-nums inline-flex">
